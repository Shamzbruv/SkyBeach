...
export const hutStories = [
  ...
  {
    name: "Pon Piece Hut",
    placeNote: "An easygoing booth made for settling in",
    story:
  ...
  },
  {
    ...
    placeNote: "A long-table gathering place with local character",
    story:
  ...
  {
    name: "Seaview Hut",
    placeNote: "Warm timber framing with an open-air outlook",
    story:
